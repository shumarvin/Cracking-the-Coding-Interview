...
public class ReturnKthToLastTester
{
    ...
    {
        MyLinkedList list = new MyLinkedList(new Node<Integer>(1,null));
        list.insertNode(new Node<Integer>(77,null));
        list.insertNode(new Node<Integer>(45,null));
        list.insertNode(new Node<Integer>(90,null));
        list.insertNode(new Node<Integer>(80,null));
